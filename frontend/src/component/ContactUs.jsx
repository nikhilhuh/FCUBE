...
function ContactUs() {
  ...
  const handleSendMessage = (e) => {    
    ...
    if (!name || !subject || !phoneNumber) {
      ...
      Swal.fire({
            title: "Error Contacting",
            text:
              "Could not send your contact request as backend is temporarily down.",
            icon: "error",
            customClass: {
              popup: "max-w-[80vw] md:max-w-[50vw]",
  ...
  return (
    <section className="bg-primary">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-white mt-[30px] lg:mt-[20px]">
          Contact Us
        </h2>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSendMessage(); }} className="space-y-8 w-full">
          <div>
            <label
              htmlFor="order-name"
              className="block mb-2 text-sm font-medium max-w-max text-gray-300"
            >
              Your Name
            </label>
            <input
          ...
          <div>
            <label
              htmlFor="subject"
              className="block mb-2 text-sm max-w-max font-medium text-gray-300"
            >
              Subject
            </label>
            <input
          ...
          <div className="sm:col-span-2">
            <label
              htmlFor="message"
              className="block mb-2 text-sm max-w-max font-medium text-gray-400"
            >
              Your message
            </label>
            <textarea
